...
function initGlobalKPIs(dados) {
    ...
    // Calcula o Saldo de Evolução e Médias para a Aba Estatísticas
    let saldoEvolucao = 0;
...
// UI Functions para Estat�sticas e Modal
...
const mejdDocs = {
    faturamento: {
        ...
        text: 'Representa a receita bruta gerada atrav�s da entrega de projetos e servi�os da Empresa J�nior. � o principal indicador de impacto no mercado e de sustentabilidade financeira da EJ no ciclo.'
    },
    csat: {
        title: 'CSAT (Customer Satisfaction Score)',
        text: 'Mede o grau de satisfa��o dos clientes em rela��o aos projetos entregues. � calculado atrav�s da m�dia das notas de avalia��o disparadas ao final de cada projeto, numa escala convertida de 1 a 5.'
    },
    engajamento: {
        title: 'Engajamento com o MEJ',
        text: 'Indica a propor��o de membros da Empresa J�nior que realizaram ou est�o ativamente alocados em projetos de consultoria no ciclo atual, medindo a capacidade da EJ de proporcionar viv�ncia empresarial a todos.'
    },
    tempo: {
        title: 'Tempo de Perman�ncia',
        text: 'Reflete a m�dia de tempo que os membros permanecem ativos na empresa. Um tempo ideal demonstra uma boa reten��o de talentos e um pipeline de lideran�a saud�vel para o crescimento da EJ.'
    }
};
